...
c		  ;'; approximated by rho=',rho
		  ...
		  do jv = 1, nabsv
			 vel = vgta(jv,kr)
cERN               Avoid underflow
                   if(vel/vttab(intab,ispa) < 25.0d0)then  
...
cERN	Output added 23/06/05
        FILE_NAME = paplda // "QLFP_distribution.dat"
     ...
     ;              IOSTAT = OpenStat, ACTION = "WRITE")
	              ...
	              if (OpenStat > 0) then
	                  ...
	                  stop
	  				  ...
	  				  write(77,*),"Non-Maxwellian dist. generated by CYRANO"
	  				  write(77,*),"(read_QLFP.f)"	  
