...
c     -------------
	...
	write(nofile,*) 'B.C. at inner metal shell'
	  ...
	  print *, 'FLR ops. not implemented in inner wall boundary conditions'
	  write(nofile,*) 'FLR ops. not implemented in inner wall boundary conditions'
	  end if
      i = 0
...
c       ++++
	  print *, 'FLR ops. not implemented in axis boundary conditions'
	  write(nofile,*) 'FLR ops. not implemented in axis boundary conditions'
c	  stop
