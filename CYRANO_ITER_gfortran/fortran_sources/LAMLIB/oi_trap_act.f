      SUBROUTINE oi_trap_act(xin, vin, sigm, mav, Nmdiff, qovm, xtg, xo,
     ;                                     thein, residue, FLAG)
...
c	integer itmax2, ilast_R, ilast_L, Nins
	...
	real*8 :: gammadd, theres, mdiff, kp, kpp, deltwa, themax 
	real*8 :: Raux
...
c               write(1553,"(400G16.8)")
               write(1553,"(400G16.8)"), xin, xnout, xtg, themax, theres, 0.d0
