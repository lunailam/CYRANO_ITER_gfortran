...
c           Estimate residual charge due to spectrum truncation: (not normalized yet!)
          ...
          write(nofile,*)'cokpco - filant: residual charges from full fft spectrum'
	      do im = 1, nmoant
	      write(nofile,*)moant(im), '  ', rescha_spectrum(im)
	      end do
          write(nofile,*)'cokpco - filant: residual charges from truncated spectrum'
	      do im = 1, nmoant
	      write(nofile,*)moant(im), '  ', rescha_truncated(im)
	      end do
