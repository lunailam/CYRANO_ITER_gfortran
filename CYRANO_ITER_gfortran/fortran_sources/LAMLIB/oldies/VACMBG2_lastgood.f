...
c     On output, V2 includes the coefficients of 1/y when SEPAR is true.
      ...
      integer ini, k2, l, ic, j, ka, ii, ji, idest(9), id, jd
...
c     =========================================
c     This case was programmed using only fft of real coefficients.
...
c     ====
c     Cases: 'HEC' elements with COKPCO=.FALSE. or .TRUE.; or 'M23' with COKPCO=.T.
...
c     Eventual transformation from rho, eta, // to +,-,// components:
