      SUBROUTINE oi_trap_react_double_anal(xin, vin, sigm, mav, Nmdiff, qovm, xtg, xtg2,xo,
...
c      if(FLAG)then
         write(1559,"(1000G16.8)"), xin, xnout, NTT, theres, theres2, meuteste(1:NTT)
         write(1559,"(1000G16.8)"), xin, xnout, NTT, theres, theres2, th(1:NTT)
      ...
      END SUBROUTINE oi_trap_react_double_anal