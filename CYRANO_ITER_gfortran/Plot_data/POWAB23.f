...
ccccccccccccccccccccc LUENNE ccccccccccccccccccccc         
      call cpu_time(start)
cccccccccccc inicio contagem de tempo cccccccccccc

c     INICIO PRIMEIRO TRECHO	  
...
c     FINAL PRIMEIRO TRECHO	 (2.1656559999917135)
ccccccccccccccccccccc LUENNE ccccccccccccccccccccc      
      call cpu_time(finish)
	     temp_total = temp_total + (finish - start)
c      temp_total = temp_total + 1
cccccccccccccccccccccccccccccccccccccccccccccccccc	


c     INICIO SEGUNDO TRECHO	 
      insc = inscr(ireg)
...
c     FINAL SEGUNDO TRECHO (26.668002999999999)
	  
c     INICIO TERCEIRO TRECHO
ccccccccccccccccccccc LUENNE ccccccccccccccccccccc         
...
c     FINAL TERCEIRO TRECHO (103.01741600002606)

ccccccccccccccccccccc LUENNE ccccccccccccccccccccc      
c      call cpu_time(finish)
c	     temp_total = temp_total + (finish - start)
c      temp_total = temp_total + 1
cccccccccccccccccccccccccccccccccccccccccccccccccc	

c     INICIO QUARTA TRECHO
...
c     FINAL QUARTA TRECHO (11.738183000016420)
